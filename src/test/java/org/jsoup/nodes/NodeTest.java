...
//        // Case 1: Node ไม่มี parent (ต้องคืน null)
//        Element loneElement = new Element("div");
//        assertNull(loneElement.parent());
//        // ✅ เรียกโดยตรงจาก Element → Node.parent() ถูกเรียกจริง
//
//        // Case 2: Node มี parent (ต้องคืนค่าที่เป็น parent จริง)
//        Document doc = Jsoup.parse("<div id='p'><p id='c'></p></div>");
//        Element child = doc.selectFirst("#c");
//        Element parent = doc.selectFirst("#p");
//        assertEquals(parent, child.parent());
//        // ✅ parentNode ใน Node ถูกเรียกผ่าน Element โดยตรง
//
//        // Case 3: TextNode ที่อยู่ใน Element (เพิ่มเติม)
//        TextNode text = new TextNode("hello");
//        parent.appendChild(text);
//        assertEquals(parent, text.parent());
//        // ✅ ครอบคลุม subclass อื่นของ Node ด้วย
//    }
////void Test_parent() {
////    // Case 1: Document ไม่มี parent
//////    String html = "<div><svg><path>1,2,3</path></svg></div>";
//////    Node doc = Jsoup.parse(html);
//////    assertNull(doc.parent()); // ✅ Document ไม่มี parent
////
////    // Case 2: Element child มี parent เป็น div
//////    Document doc1 = Jsoup.parse("<div id='p'><p id='c'>hello</p></div>");
//////    Element c = doc1.selectFirst("#c");  // <p id='c'>
//////    Element p = doc1.selectFirst("#p");  // <div id='p'>
